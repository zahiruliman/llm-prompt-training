...
## Slide 1: Your Professional Transformation Journey
...
**Outcome:** Professional capability to generate government-standard documentation in 2-3 hours instead of 2-3 weeks

---

## Slide 2: AIDevX Platform - Your Professional Documentation Engine

### **Understanding Your Digital Assistants**
...
### **The Professional Workflow at aidevx.mtssb.io**
...
### **KRISA Document Focus for This Session**
...
## Slide 3: Expert Persona Strategy

### **The Professional Consultant Approach**

When you hire a consultant for a critical government project, you choose someone with specific expertise, experience, and domain knowledge. The same principle applies to AIDevX - you must define the expert persona who will create your KRISA documents.
...
### **Your Expert Selection Challenge**
...
**C)** Software Testing Lead with healthcare system experience

### **Discussion Focus:** How does expert selection impact the quality and compliance readiness of your KRISA documents?

---

## Slide 5: Project Intelligence Framework

### **The Executive Briefing Approach**

Imagine briefing a new senior consultant who's joining your project mid-stream. They're highly qualified but know nothing about your specific project context. A successful briefing requires complete information transfer - the same principle applies to AIDevX.

### **The Information Gap That Kills Quality**

AIDevX has extensive knowledge about KRISA methodology, government standards, and technical frameworks. However, it has zero knowledge about your specific project context. This gap is what separates generic outputs from government-ready documents.
...
system that must:
- Replace current 14-day manual approval process with 7-day digital workflow
- Integrate with existing DBKL property database and One Stop Centre system
- Support 5 permit types: residential, commercial, renovation, signage, temporary structure
- Comply with Malaysia Building Standards Act and PDPA requirements
...
### **Professional Context Development Exercise**
...
- What systems must integrate? (MyKad, existing databases, payment systems?)
...
- **User Context**: Primary and secondary users, usage scenarios

**STEP 3: Expert Validation (2 minutes)**
...
## Slide 7: Professional Template Methodology

### **The Master Craftsman's Approach**

Think of a master craftsman training an apprentice. Instead of explaining how to shape wood, they show the apprentice a perfect example and say "make it exactly like this." AIDevX works the same way - it learns patterns from examples more effectively than from descriptions.
...
### **TEMPLATE METHODOLOGY IN ACTION: KRISA Requirements**
...
**⏰ Time:** 8 minutes | **👥 Format:** Individual/Pair work

---

## Slide 9: Blueprint Planning Method

### **The Architect's Approach: Plan Before Building**
...
Present this blueprint for validation before generating the full SRB document.
```

**Why This Works:** Bank can validate the technical approach before investing time in detailed documentation.
...
- No real-time tracking for employees
...
- Which new components need to be built from scratch?

STEP 2: User Journey Architecture  
- Map the complete claim submission process flow
- Identify all approval levels and decision points

STEP 3: Data Architecture
- What information flows between systems?
- How do we maintain audit trails for government compliance?

STEP 4: Integration Architecture
- How does this connect to HRMIS for employee verification?
- What about integration with government finance systems?
```

**Deliverable:** One complete blueprint planning prompt ready for AIDevX

**Time:** 10 minutes | **Format:** Pair work | **Outcome:** Present one solution to class

---

## Slide 11: Professional Document Refinement

### **The Master Chef's Method: Perfect Through Practice**

A master chef doesn't create the perfect dish on the first attempt. They taste, adjust seasoning, modify cooking time, and refine until it's restaurant-quality. Similarly, professional KRISA documents require methodical refinement to meet government standards.

### **The Professional Refinement Process**

Instead of starting over when a document isn't quite right, we guide AIDevX through specific improvements, just like a head chef guiding a junior cook.
...
**Professional Tip:** Government documents require multiple review cycles. Plan for 3-4 refinement rounds for critical documents like SRB.
...
- **Compliance notes** (PDPA for personal data handling)

**Expected Output:** 4-5 separate, implementable requirements replacing the single vague one.

---

## Slide 13: Professional Style Replication

### **The Master Tailor's Technique: Perfect Fit Every Time**

Imagine a master tailor who can look at a well-fitted suit and recreate that exact style for any customer. That's what we're teaching AIDevX - to analyze a perfectly formatted government document and apply that same professional styling to completely new content.

### **Why Style Consistency Matters in Government**

Malaysian government agencies have established document formats that reflect professionalism and compliance. When we create new KRISA documents, they must match these standards exactly.

---

### **THE STYLE REPLICATION PROCESS**
...
Instead of describing what you want, show AIDevX exactly how it should look

---

### **Real Government Example: MAMPU to JPN Document Transfer**

**Scenario:** MAMPU created a perfect project proposal template. JPN needs to use the same format for their citizen services project.

**Traditional Approach:** Spend hours trying to describe the format
**Professional Approach:** Use style replication to instantly apply MAMPU's formatting to JPN's content

**Time Saved:** 4-6 hours of formatting work → 10 minutes of style transfer
...
This initiative aligns with National Digital Policy framework...

2.0 KEY DECISIONS APPROVED
Decision 2.1: Budget allocation of RM 2.5 million approved
Decision 2.2: Implementation timeline extended to Q2 2024

3.0 IMPLEMENTATION ROADMAP
Phase 1 (Oct-Dec 2023): Requirements gathering and vendor selection
```
...
- New privacy framework mandatory for all AI systems
- Pilot project with 3 agencies starting January 2024
- Weekly steering committee meetings required
```
...
**Format:** Pair work | **Presentation:** Best solution shared with class

---

## Slide 15: Master Professional Workflow

### **From Raw Ideas to Government-Ready Documents: The Complete Process**

You now have all the tools a professional Business or System Analyst needs to create world-class KRISA documents. Here's how to combine everything into a repeatable, reliable workflow.
...
FOUNDATION → PLANNING → EXECUTION → REFINEMENT
    ↓           ↓           ↓           ↓
Expert         Blueprint    Style      Quality
Persona +  →   Planning  →  Execution → Assurance
...
## Slide 16: Professional Certification Challenge

### **Master Practitioner Assessment: Complete Project Documentation**

You've learned all six professional techniques. Now prove your mastery with a real government project scenario that requires the full professional workflow.

---

### **PROJECT BRIEFING: Malaysia Digital ID System**

**Your Role:** Lead Business Analyst, Prime Minister's Department
**Project:** National Digital Identity verification system for all government services
...
- Cannot disrupt current MyKad usage during transition
...
- Production-ready prompt quality

**Time:** 15 minutes | **Format:** Individual work | **Outcome:** Ready for real-world application

---

## Slide 17: Professional Mastery Achieved

### **Your New Professional Capabilities**

You now possess the complete toolkit for creating government-standard KRISA documents using AI assistance. These aren't just techniques - they're professional skills that will accelerate your career and project success.
...
**Training Materials:** Complete reference guide in project repository
